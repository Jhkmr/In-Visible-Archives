...
function draw() {
  ...
  numBandsSlider.position(gridX + 100, gy + 110);
  ...
  text('Bands: '     + numBandsSlider.value(),        gridX + 100 + numBandsSlider.width + 4, gy + 116);
...
function layoutProgression(gw, gh) {
  ...
  for (let i = 0; i < numBands; i++) {
    ...
    let contours = r.cropPg ? extractContours(r.cropPg, blurK, threshSlider.value()) : [];
